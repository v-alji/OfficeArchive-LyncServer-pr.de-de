...
Alle Einstellungen können dann mithilfe des Set-CsAVEdgeConfiguration-Cmdlets geändert werden. Weitere Informationen finden Sie in den Hilfethemen zu den Cmdlets [New-CsAVEdgeConfiguration](https://technet.microsoft.com/library/Gg412884(v=OCS.15)) und Cmdlets für [festgelegte CsAVEdgeConfiguration](https://technet.microsoft.com/library/Gg412869(v=OCS.15)) .
...
## <a name="to-modify-existing-av-edge-configuration-settings"></a>So ändern Sie vorhandene A/V-Edge-Konfigurationseinstellungen
  ...
  - In diesem Beispiel wird das Set-CsAVEdgeConfiguration-Cmdlet verwendet, um die maximale Token-Lebensdauer für den Standort Redmond auf 12 Stunden zu ändern:
