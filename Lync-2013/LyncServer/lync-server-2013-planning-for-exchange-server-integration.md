...
---
# <a name="planning-for-exchange-server-integration-with-lync-server-2013"></a>Planen der Exchange Server-Integration in lync Server 2013
...
Wenn Sie Exchange und lync Server in Ihrer Organisation bereitstellen, werden viele Features in beiden Produkten verbessert. Dieser Abschnitt enthält Informationen zu diesen Funktionen.

<div>

## <a name="in-this-section"></a>In diesem Abschnitt

  - [Integration von Microsoft lync Server 2013 und Microsoft Exchange Server 2013](lync-server-2013-integrating-with-microsoft-exchange-server-2013.md)
