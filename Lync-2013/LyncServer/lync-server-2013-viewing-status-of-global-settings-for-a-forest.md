...
SIP-Domäneninformationen können mithilfe von Windows PowerShell und dem Cmdlet **Get-CsSipDomain** zurückgegeben werden. Wenn Sie diese Informationen zurückgeben möchten, führen Sie den `Get-CsSipDomain` Windows PowerShell-Befehl aus.
...
Get-CsMeetingConfiguration – Identität "globale" Besprechungs Konfigurationseinstellungen können auch im Website Bereich konfiguriert werden. Aus diesem Grund sollten Sie den folgenden Befehl verwenden, der Informationen zu allen Besprechungs Konfigurationseinstellungen zurückgibt:
...
Das Get-CsArchivingConfiguration-Cmdlet gibt Daten ähnlich wie folgt zurück:
...
Informationen zur Archivierungsrichtlinie können mithilfe des Get-CsArchivingPolicy-Cmdlets abgerufen werden. Dieser Befehl gibt beispielsweise Informationen zur globalen Archivierungsrichtlinie zurück:
...
Die Informationen, die Sie von Get-CsArchivingPolicy erhalten, ähneln Ihnen wie folgt:
...
Das Get-CsCdrConfiguration-Cmdlet gibt für jede Sammlung von CDR-Konfigurationseinstellungen ähnliche Informationen zurück:
...
Ähnliche Informationen können für die QoE-Überwachung mithilfe des Get-CsQoEConfiguration-Cmdlets zurückgegeben werden. Dieser Befehl gibt beispielsweise Informationen zur globalen Sammlung der QoE-Konfigurationseinstellungen zurück:
...
Das Get-CsDialInConferencingConfiguration-Cmdlet gibt Daten ähnlich wie folgt zurück:
