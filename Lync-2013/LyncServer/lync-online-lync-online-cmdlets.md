...
Die folgenden Cmdlets können nur in Verbindung mit lync Online verwendet werden:
...
Informationen dazu, wie Sie Ihren Computer für die Verwendung von Windows PowerShell zum Verwalten mit lync Online konfigurieren, finden Sie im Hilfethema [Verwenden von Windows PowerShell zum Verwalten von lync Online](https://technet.microsoft.com/library/Dn362831(v=OCS.15)).
