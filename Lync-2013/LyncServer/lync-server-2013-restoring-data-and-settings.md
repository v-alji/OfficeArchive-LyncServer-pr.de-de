...
## <a name="in-this-section"></a>In diesem Abschnitt
  ...
  - [Vorbereiten der Wiederherstellung von lync Server 2013](lync-server-2013-preparing-to-restore-lync-server.md)
  ...
  - [Wiederherstellen des Servers, auf dem der zentrale Verwaltungsspeicher in lync Server 2013 gehostet wird](lync-server-2013-restoring-the-server-hosting-the-central-management-store.md)
  ...
  - [Durchführen eines ABC-Front-End-Pool-Failovers in lync Server 2013](lync-server-2013-performing-an-abc-front-end-pool-failover.md)
  ...
  - [Wiederherstellen beständiger Chat-Daten in lync Server 2013](lync-server-2013-restoring-persistent-chat-data.md)
