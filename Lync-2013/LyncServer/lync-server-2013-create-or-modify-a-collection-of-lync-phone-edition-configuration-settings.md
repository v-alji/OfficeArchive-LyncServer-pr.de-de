...
Die Konfigurationseinstellungen bestehen aus dem Sammlungsnamen, dem Bereich (Global oder Website), der SIP-Sicherheitseinstellung, dem Protokolliergrad, der sprach Dienstleistungsqualität (QoS), der Einstellung für die Telefonsperre und den Details der Telefonsperre, d. h., wie lange die a)-Sperre für persönliche Identifikationsnummer (PIN) und b) im Leerlauf ist, bevor Sie sich
