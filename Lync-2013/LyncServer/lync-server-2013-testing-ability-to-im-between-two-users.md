...
Das Test-CsIM-Cmdlet überprüft, ob ein paar Testbenutzer Sofortnachrichten austauschen können. Wenn Sie aufgerufen wird, beginnt das Test-CsIM-Cmdlet, indem Sie versuchen, ein paar Testbenutzer mit lync Server anzumelden. Wenn die beiden Anmeldungen erfolgreich sind, startet das Cmdlet dann eine Chatsitzung zwischen den beiden Testbenutzern. (Benutzer 1 lädt Benutzer 2 zu einer Chatsitzung ein, und Benutzer 2 nimmt die Einladung an.) Nachdem Sie überprüft haben, ob Nachrichten zwischen den beiden Benutzern ausgetauscht werden können, beendet Test-CsIM die Chatsitzung und protokolliert beide Benutzer vom System.
...
Wenn der Verbose-Parameter enthalten ist, gibt Test-CsIM eine Schritt-für-Schritt-Konto für jede Aktion zurück, die versucht wurde, als Sie die Fähigkeit der beiden Testbenutzer zur Teilnahme an einer Chatsitzung überprüft hat. Hier finden Sie beispielsweise eine Beispielausgabe, die auftritt, wenn eine falsche Gruppe von Benutzeranmeldeinformationen (in diesem Fall ein falsches Kennwort) für Test-CsIM bereitgestellt wird:
...
Im folgenden finden Sie einige häufige Gründe, warum Test-CsIM fehlschlagen kann:
