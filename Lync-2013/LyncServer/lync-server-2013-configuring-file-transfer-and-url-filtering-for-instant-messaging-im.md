...
Wenn Sie **Links blockieren** oder **Warnmeldung senden** auswählen, stehen die folgenden Optionen zur Verfügung:
  ...
  - **Filtern dieser Link Präfixe**   Wenn Sie auswählen möchten, welche Präfixe blockiert werden sollen, klicken Sie auf **auswählen**, und fügen Sie dann unter **Link Präfix auswählen** die Präfixe der Liste **Hyperlink-Präfixe** hinzu.
