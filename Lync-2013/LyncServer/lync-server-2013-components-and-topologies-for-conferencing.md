...
Zusätzlich zu den Anforderungen für Webkonferenzen und A/V-Konferenzen verwendet Einwahlkonferenzen die folgenden lync Server 2013-Komponenten:
  ...
  - **Dateispeicher**   Dateispeicher wird für aufgezeichnete Namen-Audiodateien verwendet. Er ist eine Standardkomponente in jeder Enterprise Edition- oder Standard Edition-Bereitstellung.

  - **Benutzerspeicher**   Der Benutzerspeicher wird zum Speichern von Benutzer-lync Server 2013-Pins verwendet. Für PINs wird ein Hashalgorithmus verwendet. Der Benutzerspeicher ist eine Standardkomponente in jeder Enterprise Edition- oder Standard Edition-Bereitstellung.

  - **Lync Server-System**   Steuerung   Einige Einwahleinstellungen können mithilfe der lync Server-Systemsteuerung konfiguriert werden.
