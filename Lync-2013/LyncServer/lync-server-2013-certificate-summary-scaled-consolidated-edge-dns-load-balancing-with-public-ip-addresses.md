...
## <a name="scaled-consolidated-edge-using-dns-load-balancing-with-public-ip-addresses"></a>Skalierter konsolidierter Edge mithilfe des DNS-Lastenausgleichs mit öffentlichen IP-Adressen
