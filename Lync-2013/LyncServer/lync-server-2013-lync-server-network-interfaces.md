...
---
# <a name="lync-server-2013-network-interfaces"></a>Lync Server 2013-Netzwerkschnittstellen
...
Verwenden Sie die Verfahren in diesem Abschnitt, um Netzwerkschnittstellen für Ihre lync Server 2013-Umgebung zu verwalten.

<div>

## <a name="in-this-section"></a>In diesem Abschnitt

  - [Anzeigen von Netzwerkschnittstelleninformationen in lync Server 2013](lync-server-2013-viewing-network-interface-information.md)
