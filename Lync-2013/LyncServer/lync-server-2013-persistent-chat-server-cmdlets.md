...
---
# <a name="persistent-chat-server-cmdlets-in-lync-server-2013"></a>Server-Cmdlets für beständigen Chat in lync Server 2013
...
Mit den Cmdlets für beständigen Chat können Sie den beständigen Chatdienst von Microsoft lync Server 2013 (vormals als Gruppen-Chat-Dienst bezeichnet) verwalten und konfigurieren. Der beständige Chat ermöglicht Benutzern die Teilnahme an Online-Chat-Sitzungen. Obwohl diese Sitzungen in Echtzeit erfolgen können, ist der Inhalt jeder Sitzung persistent; Das bedeutet, dass diese Unterhaltungen von jeder Person jederzeit wieder aufgenommen werden können.

<div>

## <a name="persistent-chat-cmdlets"></a>Cmdlets für beständigen Chat

Mit den Cmdlets für beständigen Chat können Sie den lync Server-beständigen Chatdienst verwalten und konfigurieren.

**Cmdlets für beständigen Chat**
