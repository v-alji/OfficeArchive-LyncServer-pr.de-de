...
Das Cmdlet [Move-CsLegacyUser](https://technet.microsoft.com/library/Gg413025(v=OCS.15)) bietet eine Möglichkeit, Benutzerkonten von Office Communications Server 2007 oder Microsoft lync Server 2010 auf Microsoft lync Server 2013 zu verschieben. Wenn Sie ein Benutzerkonto nach "rückwärts" verschieben möchten (beispielsweise von Microsoft lync Server 2013 zu Microsoft lync Server 2010), verwenden Sie das Cmdlet [Move-CsUser](https://technet.microsoft.com/library/Gg398528(v=OCS.15)) .
