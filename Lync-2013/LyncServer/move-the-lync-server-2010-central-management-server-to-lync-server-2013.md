...
## <a name="preparing-lync-server-2013-front-end-servers-before-moving-the-central-management-server"></a>Vorbereiten der lync Server 2013-Front-End-Server vor dem Verschieben des zentralen Verwaltungsservers
...
## <a name="to-move-the-lync-server-2010-central-management-server-to-lync-server-2013"></a>So verschieben Sie den lync Server 2010 Central-Verwaltungs Server nach lync Server 2013
...
## <a name="to-remove-lync-server-2010-central-management-store-files-after-a-move"></a>So entfernen Sie nach einem Umzug lync Server 2010 Central Management Store-Dateien
...
3.  Wenn Sie die zentralen Verwaltungsspeicher-Datenbankdateien vom lync Server 2010 Central-Verwaltungs Server entfernen möchten, geben Sie Folgendes ein:
    ...
    Dabei \<FQDN of SQL Server\> handelt es sich entweder um den lync Server 2010-Back-End-Server in einer Enterprise Edition-Bereitstellung oder um den FQDN des Standard Edition-Servers.
