...
4.  Klicken Sie mit der rechten Maustaste auf die Gruppe, und klicken Sie dann auf **Umbenennen**. Benennen Sie die Gruppe um, indem Sie **\_ 50** am Ende des Gruppennamens direkt vor dem Namen der SQL Server-Instanz hinzufügen. Beispiel: **SQLServerReportServerUser $ ATL-SC-001 $ MSRS10 \_ 50. ARCHINST**.
