...
<!-- end list -->
  ...
  - **Planen Sie die Aktivierung von E9-1-1 für Benutzer außerhalb des Netzwerks?**  
    ...
    > [!NOTE]  
    > Lync-Clients von Benutzern, die mithilfe von VPN eine Verbindung mit dem Netzwerk Ihrer Organisation herstellen, können interne IP-Adressinformationen aufnehmen, aber da diese Adressen nicht zur Identifizierung des tatsächlichen Standorts des Benutzers verwendet werden können, ist es wichtig, dass VPN-Subnetze vom standortinformationsdienst ausgeschlossen werden.
