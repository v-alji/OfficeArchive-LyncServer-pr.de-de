...
Die folgenden Abschnitte sind enthalten:
  ...
  - [Betriebs Abhängigkeiten in lync Server 2013](lync-server-2013-operational-dependencies.md)

  - [Problembehandlung und wichtige Integritätsindikatoren in lync Server 2013](lync-server-2013-troubleshooting-and-key-health-indicators.md)

Es wird davon ausgegangen, dass Ihre Microsoft lync Server 2013-Bereitstellung abgeschlossen ist. Wenn dies nicht der Fall ist, lesen Sie den Planungs-und Bereitstellungs Inhalt für Microsoft lync Server 2013, bevor Sie fortfahren.
