...
> [!TIP]  
> Wenn Sie beabsichtigen, die Edgeserver und Reverse Proxy zu installieren und später Features hinzuzufügen (beispielsweise Föderation und Mobilität), legen Sie fest, welche Zertifikate für alle Dienste nach der Bereitstellung erforderlich sind. Wenn Sie die Zertifikate für alle Features im Voraus planen und erwerben, zunächst bereitgestellt oder nicht, müssen Sie keine neuen Zertifikate mehr anfordern, um die Anforderungen des Verbandes (also auf den Edgeserver) oder des Reverse-Proxys (also für Mobilitätsdienste) zu erfüllen.
