...
3.  Verwenden Sie das Cmdlet **Remove-CsNetworkInterSitePolicy** , um einen Netzwerkstandort Link zu entfernen. Im folgenden Beispiel wird der Link zur Portland-Netzwerk Website von Reno gelöscht \_ :
