...
## <a name="in-this-section"></a>In diesem Abschnitt
  ...
  - [Konfigurieren von Einstellungen für den Medienportbereich in lync Server 2013](lync-server-2013-configuring-media-port-range-settings.md)
  ...
  - [Konfigurieren von Standardbild Optionen in lync Server 2013](lync-server-2013-configuring-default-picture-options.md)
