...
---
# <a name="persistent-chat-compliance-in-lync-server-2013"></a>Kompatibilität für beständigen Chat in Lync Server 2013
...
So erhalten Sie die Kompatibilitäts Konfiguration für beständigen Chat

    Get-CsPersistentChatComplianceConfiguration [-Identity <XdsIdentity>] [-LocalStore <Switch Parameter>]

So setzen Sie die Kompatibilitäts Konfiguration für beständigen Chat
