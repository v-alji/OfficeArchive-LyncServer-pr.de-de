...
4.  Klicken Sie im **Start Index des Benutzers** auf den Index des ersten Benutzers, den Sie konfigurieren möchten, oder geben Sie ihn ein. Sie können unterschiedliche Bereiche für verschiedene Typen oder lade Ebenen konfigurieren, Sie müssen jedoch UserProfileGenerator.exe einmal pro Bereich ausführen, den Sie konfigurieren möchten.
